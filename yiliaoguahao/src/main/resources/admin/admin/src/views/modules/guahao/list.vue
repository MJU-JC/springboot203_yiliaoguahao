            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '号' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.guahaoUuidNumber" placeholder="号" clearable></el-input>
                     </el-form-item>
                
                                         
                    <el-form-item :label="contents.inputTitle == 1 ? '挂号人员姓名' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.guahaorenyuanName" placeholder="挂号人员姓名" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/yiliaoguahao/upload/guahaoMuBan.xls"
                        >批量导入挂号数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('guahao','导入导出')"
            ...
            <div class="table-content">
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="guahaorenyuanName"
                                      header-align="center"
                                      label="挂号人员姓名">
                        <template slot-scope="scope">
                            {{scope.row.guahaorenyuanName}}
                        </template>
                    </el-table-column>
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="guahaorenyuanPhone"
                                      header-align="center"
                                      label="挂号人员手机号">
                        <template slot-scope="scope">
                            {{scope.row.guahaorenyuanPhone}}
                        </template>
                    </el-table-column>
                    <!--<el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                                      prop="guahaorenyuanIdNumber"
                                      header-align="center"
                                      label="挂号人员身份证号">
                        <template slot-scope="scope">
                            {{scope.row.guahaorenyuanIdNumber}}
                        </template>
                    </el-table-column>
                    <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="guahaorenyuanPhoto"
                               header-align="center"
                               width="200"
                               label="挂号人员头像">
                        <template slot-scope="scope">
                            <div v-if="scope.row.guahaorenyuanPhoto">
                                <img :src="scope.row.guahaorenyuanPhoto" width="100" height="100">
                            </div>
                            <div v-else>无图片</div>
                        </template>
                    </el-table-column>-->
...
<script>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     '挂号人员姓名': 'guahaorenyuanName',
                     '挂号人员手机号': 'guahaorenyuanPhone',
                     '挂号人员身份证号': 'guahaorenyuanIdNumber',
                     '挂号人员头像': 'guahaorenyuanPhoto',
                     '患者姓名': 'huanzheName',
                     '患者手机号': 'huanzhePhone',
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.guahaorenyuanName!= '' && this.searchForm.guahaorenyuanName!= undefined) {
                    params['guahaorenyuanName'] = '%' + this.searchForm.guahaorenyuanName + '%'
                }
                ...
                if (this.searchForm.guahaoUuidNumber!= '' && this.searchForm.guahaoUuidNumber!= undefined) {
                    params['guahaoUuidNumber'] = '%' + this.searchForm.guahaoUuidNumber + '%'
                }
