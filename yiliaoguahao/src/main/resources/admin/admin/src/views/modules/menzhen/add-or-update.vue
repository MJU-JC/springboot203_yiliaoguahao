    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="门诊名称" prop="menzhenName">
                       <el-input v-model="ruleForm.menzhenName"
                                 placeholder="门诊名称" clearable  :readonly="ro.menzhenName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="门诊名称" prop="menzhenName">
                           <el-input v-model="ruleForm.menzhenName"
                                     placeholder="门诊名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="门诊位置" prop="menzhenAddress">
                       <el-input v-model="ruleForm.menzhenAddress"
                                 placeholder="门诊位置" clearable  :readonly="ro.menzhenAddress"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="门诊位置" prop="menzhenAddress">
                           <el-input v-model="ruleForm.menzhenAddress"
                                     placeholder="门诊位置" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="星期几坐诊" prop="xingqiji">
                       <el-input v-model="ruleForm.xingqiji"
                                 placeholder="星期几坐诊" clearable  :readonly="ro.xingqiji"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="星期几坐诊" prop="xingqiji">
                           <el-input v-model="ruleForm.xingqiji"
                                     placeholder="星期几坐诊" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="门诊详情" prop="qitaContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.qitaContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.qitaContent" label="门诊详情" prop="qitaContent">
                            <span v-html="ruleForm.qitaContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   menzhenAddress: [
                              { required: true, message: '门诊位置不能为空', trigger: 'blur' },
                          ],
                   xingqiji: [
                              { required: true, message: '星期几坐诊不能为空', trigger: 'blur' },
                          ],
                   qitaContent: [
                              { required: true, message: '门诊详情不能为空', trigger: 'blur' },
                          ],
                   insertTime: [
                              { required: true, message: '添加详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`menzhen/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.menzhenCrossAddOrUpdateFlag = false;
                                        this.parent.search();
