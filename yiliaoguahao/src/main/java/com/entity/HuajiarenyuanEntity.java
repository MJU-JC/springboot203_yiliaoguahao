...
public class HuajiarenyuanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public HuajiarenyuanEntity() {

	}

	public HuajiarenyuanEntity(T t) {
		try {
    ...
    public String toString() {
        return "Huajiarenyuan{" +
            "id=" + id +
            ", username=" + username +
            ", password=" + password +
            ", huajiarenyuanName=" + huajiarenyuanName +
            ", huajiarenyuanPhone=" + huajiarenyuanPhone +
            ", huajiarenyuanIdNumber=" + huajiarenyuanIdNumber +
            ", huajiarenyuanPhoto=" + huajiarenyuanPhoto +
            ", sexTypes=" + sexTypes +
